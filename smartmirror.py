...
class SmartMirrorApplication(tkinter.Tk):
    ...
    def create_bottom_frame(self):
        ...
        frames.SpotifyFrame(bottom_frame, mirrordata.Spotify(config.SPOTIFY_APP_ID, config.SPOTIFY_APP_SECRET, config.SPOTIFY_REFRESH_TOKEN), 128).pack(side="right", anchor="s")
